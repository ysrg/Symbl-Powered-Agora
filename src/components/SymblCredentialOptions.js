...
//    const [close,setClose]=useState(true);
   ...
   //let open=false;
    const close=()=>{
        ...
        let x=document.getElementById("dc");
    ...
    return (
        ...
        <DialogContent id={"dc"}  >
                ...
                <Button
                    ...
                    onClick={async () => {
                        try {
                            ...
                            const result = await getAccessToken(JSON.stringify({appId}), JSON.stringify({appSecret}));
                            console.log(result);
            ...
            <DialogActions >
                <Button disabled={!credentialsValid} className={classes.button} onClick={onClose}>
                    Done
                </Button>
            </DialogActions>
