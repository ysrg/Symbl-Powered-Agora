   ...
   useEffect(()=>{
    ...
    return (
        <View  style={{width:400}}>
            <div className={classes.container}  style={{marginBottom: 40,marginRight:250,marginLeft:300,width:800,height:100,overflowY:"scroll",display:"flex",flexDirection:"column-reverse",position:"absolute"}}>
                <span id="tes1" >{JSON.stringify(props.closedCaption)}</span>
                <Paper variant={"outlined"} className={classes.paper}>
                    <Typography  id ="tes" variant={"caption"} className={classes.caption} style={{backgroundColor:"black",padding:0}} >
